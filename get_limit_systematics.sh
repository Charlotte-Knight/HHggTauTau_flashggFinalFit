...
make_datacard(){
	pushd Datacard
	 ...
	 #python RunYields.py --inputWSDirMap 2018=${trees}/ws_signal_2018 --cats "SR1" --procs "HHggTauTau" --batch local --ext $tag --doSystematics --skipZeroes 
	 #python makeDatacard.py --years 2018 --ext $tag --prune --pruneThreshold 0.000001 --doSystematics
...
syst_plots(){
	pushd Combine
		...
		#combineTool.py  --expectSignal 1 -t -1 -M Impacts -d Datacard.root --redefineSignalPOI r --autoMaxPOIs "r" --rMin -5 --squareDistPoiStep --cminDefaultMinimizerStrategy 0 -m 125 --freezeParameters MH --doInitialFit --robustFit 1 --robustHesse 1
		#combineTool.py  --expectSignal 1 -t -1 -M Impacts -d Datacard.root --redefineSignalPOI r --autoMaxPOIs "r" --rMin -5 --squareDistPoiStep --cminDefaultMinimizerStrategy 0 -m 125 --freezeParameters MH --robustFit 1 --robustHesse 1 --doFits --parallel 10

		#combineTool.py  -t -1 --setParameters r=23.0 -M Impacts -d Datacard.root --redefineSignalPOI r --squareDistPoiStep --cminDefaultMinimizerStrategy 0 -m 125 --freezeParameters MH --doInitialFit --robustFit 1 --robustHesse 1
		#combineTool.py  -t -1 --setParameters r=23.0 -M Impacts -d Datacard.root --redefineSignalPOI r --squareDistPoiStep --cminDefaultMinimizerStrategy 0 -m 125 --freezeParameters MH --robustFit 1   --robustHesse 1 --doFits --parallel 10

		#combineTool.py -M Impacts -d Datacard.root --redefineSignalPOI r --autoMaxPOIs "r" --rMin -5 --squareDistPoiStep --cminDefaultMinimizerStrategy 0 -m 125 --freezeParameters MH -o impacts.json 
...
bias_study(){
	...
	do
		pushd Datacard	
			...
			#python RunYields.py --inputWSDirMap 2016=${trees}/ws_signal_2016,2017=${trees}/ws_signal_2017,2018=${trees}/ws_signal_2018 --cats ${sr} --procs "HHggTauTau,HHggWWdileptonic,HHggWWsemileptonic"  --batch local --mergeYears --skipZeroes --ext ${tag}_${sr} --doSystematics 
		...
		pushd Combine
			...
			./RunBiasStudy.py -d ../Datacard_${sr}.root -t -n 10000
			#./RunBiasStudy.py -d ../Datacard_${sr}.root -f -c "--cminDefaultMinimizerStrategy 0 --X-rtd MINIMIZER_freezeDisassociatedParams --X-rtd MINIMIZER_multiMin_hideConstants --X-rtd MINIMIZER_multiMin_maskConstraints --X-rtd MINIMIZER_multiMin_maskChannels=2 --freezeParameters MH --rMin -100 --rMax 100" 
			./RunBiasStudy.py -d ../Datacard_${sr}.root -f -c "--cminDefaultMinimizerStrategy 0 --freezeParameters MH --rMin -70 --rMax 100" -n 10000
			./RunBiasStudy.py -d ../Datacard_${sr}.root -p --gaussianFit -n 10000

			cp -r BiasPlots /home/users/fsetti/public_html/HH2ggtautau/bias_study/${tag}/${sr}/
			cp /home/users/fsetti/public_html/HH2ggtautau/niceplots/index.php /home/users/fsetti/public_html/HH2ggtautau/bias_study/${tag}/${sr}/BiasPlots/
